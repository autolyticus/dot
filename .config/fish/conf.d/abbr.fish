if not set -q abbrs_initialized
  ...
  abbr dotc 'git --git-dir=$HOME/.dot/ --work-tree=$HOME commit -m'
  ...
  abbr mntf 'sudo mount /dev/sdb1 /media/1'
  abbr mntff 'sudo mount /dev/sdb2 /media/2; and sudo mount /dev/sdb1 /media/2/boot'
  ...
  abbr pdotc 'git --git-dir=$HOME/.pdot/ --work-tree=$HOME commit -m'
